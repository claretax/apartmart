...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-4 z-[100] flex max-h-screen w-full mx-auto flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:max-w-[420px] sm:flex-col",
      className
    )}
    {...props}
  />
...
>(({ className, variant, ...props }, ref) => {
  return (
    <ToastPrimitives.Root
      ...
      duration={2000} // Shortened duration for quicker dismissal
      {...props}
    />
  )
})
